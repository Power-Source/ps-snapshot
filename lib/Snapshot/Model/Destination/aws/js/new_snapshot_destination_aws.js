jQuery(document).ready( function($) {
	...
	jQuery("select#snapshot-destination-region").on('change', function() {
		// console.log('changed');
	...
	jQuery("button#snapshot-destination-test-connection").on('click', function() {
	...
	jQuery("button#snapshot-destination-aws-get-bucket-list").on('click', function() {
