...
<?php if ( empty( $destinations ) ) : ?>
    ...
    <div class="wps-notice">
        <p><?php _e( "Du hast noch keinen Dropbox-Speicherort hinzugefügt.", SNAPSHOT_I18N_DOMAIN ); ?></p>
    </div>
...
<?php else : ?>
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <th class="wps-destination-user"><?php _e( 'Benutzer', SNAPSHOT_I18N_DOMAIN ); ?></th>
		...
		<?php foreach ( $destinations as $id => $destination ) : ?>
            ...
            <tr>
                ...
                <td class="wps-destination-user"
                    data-text="Benutzer:"><?php echo isset( $destination['account_info']['email'] ) ? esc_html( $destination['account_info']['email'] ) : '-'; ?></td>
