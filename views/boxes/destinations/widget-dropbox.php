...
<section class="wpmud-box wpsd-widget-dropbox">
	...
	<div class="wpmud-box-title has-typecon has-button">
		...
		<a class="button button-outline" href="<?php echo add_query_arg( array( 'snapshot-action' => 'add' , 'type' => 'dropbox' ), PSOURCESnapshot::instance()->snapshot_get_pagehook_url('snapshots-newui-destinations') ); ?>" class="button button-outline"><?php _e( 'Speicherort hinzufügen', SNAPSHOT_I18N_DOMAIN ); ?></a>
