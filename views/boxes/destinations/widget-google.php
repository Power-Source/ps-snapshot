...
<section class="wpmud-box wpsd-widget-google">
	...
	<div class="wpmud-box-title has-typecon has-button">
		...
		<a class="button button-outline" href="<?php echo add_query_arg( array( 'snapshot-action' => 'add' , 'type' => 'google-drive' ), PSOURCESnapshot::instance()->snapshot_get_pagehook_url('snapshots-newui-destinations') ); ?>" class="button button-outline"><?php _e( 'Speicherort hinzufügen', SNAPSHOT_I18N_DOMAIN ); ?></a>
